...
ln -sr bottom_left_corner sw-resize
ln -sr bottom_left_corner ne-resize
ln -sr bottom_left_corner se-resize
...
ln -sr bottom_right_corner nw-resize
ln -sr bottom_right_corner sw-resize
...
ln -sr bottom_side s-resize
ln -sr bottom_side n-resize
...
ln -sr right_side e-resize
ln -sr right_side w-resize
